...
### 1. Account Settings & Profile **(Renamed)**
...
* **Basic Payment Recording:** Record payments made to contractors (date, amount, method), linking payment to the contractor.

#### Not Included in MVP:
* Advanced contractor details (Service specialization, Tax ID, Insurance docs)
* Contractor-specific contracts or agreements
* Assigning contractors directly to jobs (Payments can be associated with jobs via expense tracking)
...
3.  Basic Contractor Management (Add, Edit, View)
4.  Contractor Payment Tracking
5.  Basic profitability calculation (incl. contractor costs)
6.  Weekly financial summary view
7.  Basic Tax Features (GST/QST tracking basics)
...
2.  **Core Functionality:** Users can successfully:
    ...
    * Add and manage basic client information
    * Add and manage basic contractor information
    * Track payments made to contractors
...
| Invoice Management                | High           | Medium     | Low                         | Low    | 4              |
| Tax Features (Reporting/Guidance) | Medium         | High       | Medium                      | High   | 5              |
| Contractor Management             | Medium         | High       | Low                         | Low    | 6              |
| Contractor Payment Tracking       | Medium         | High       | Low                         | Low    | 7              |
| Client Management                 | Medium         | Medium     | Low                         | Low    | 8              |
| Weekly Financial Summary          | Medium         | High       | Low                         | Low    | 9              |
| Account Settings & Profile        | Medium         | Low        | Low                         | Low    | 10             |
| Data Utilities (Export)           | Low            | Medium     | Low                         | Low    | 11             |
| UI Language Toggle                | Medium         | High       | Low                         | Low    | 12             |

*Note: Priority score is a combination of the four factors, with 1 being highest priority and 12 being lowest among included MVP features.*